...
return [
    ...
    /*
     * Sem auto-discovery: cada módulo (Modules/ — ver docs/architecture.md) registra
     * seus próprios Projectors/Reactors explicitamente no boot() do seu Service Provider, via
     * Projectionist::addProjector()/addReactor(). O scanner de diretório desta config assume a
     * convenção App\ = app/ do Laravel puro, que não bate com o namespace Modules\<Nome>\ de
     * cada módulo — registrar explicitamente é mais simples que reconfigurar o scanner por
     * módulo.
     */
